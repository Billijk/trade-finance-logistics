...
.then((result) => {
	...
	// INVOKE: requestAcceptedLC (Lender)
	return invokeCC.invokeChaincode(Constants.LENDER_ORG, Constants.CHAINCODE_VERSION, 'requestAcceptedLC', [tradeID], 'LendersBank');
}, (err) => {
	console.log('\n');
	console.log('------------------------');
	console.log('CHAINCODE QUERY FAILED:', err);
...
.then(() => {
	...
	console.log('------------------------------');
	console.log('CHAINCODE INVOCATION COMPLETE');
	console.log('requestAcceptedLC SUCCEEDED');
	console.log('------------------------------');
	console.log('\n');

	// QUERY: getAcceptedLCStatus (Lender)
	return queryCC.queryChaincode(Constants.LENDER_ORG, Constants.CHAINCODE_VERSION, 'getAcceptedLCStatus', [tradeID], 'LendersBank');
}, (err) => {
	console.log('\n');
	console.log('-----------------------------');
	console.log('CHAINCODE INVOCATION FAILED:', err);
...
.then((result) => {
	...
	console.log('-------------------------');
	console.log('CHAINCODE QUERY COMPLETE');
	console.log('getAcceptedLCStatus VALUE:', result);
	console.log('-------------------------');
	console.log('\n');

	// INVOKE: issueAcceptedLC (Exporter's Bank)
	return invokeCC.invokeChaincode(Constants.EXPORTER_ORG, Constants.CHAINCODE_VERSION, 'issueAcceptedLC', [tradeID, 'lc8349', '12/31/2018', 'E/L', 'B/L'], 'ExportersBank');
}, (err) => {
	console.log('\n');
	console.log('------------------------');
	console.log('CHAINCODE QUERY FAILED:', err);
...
.then((result) => {
	...
	console.log('-------------------------');
	console.log('CHAINCODE INVOCATION COMPLETE');
	console.log('issueAcceptedLC succeed.');
	console.log('-------------------------');
	console.log('\n');

	// QUERY: getAcceptedLCStatus (Exporter's Bank)
	return queryCC.queryChaincode(Constants.EXPORTER_ORG, Constants.CHAINCODE_VERSION, 'getAcceptedLCStatus', [tradeID], 'ExportersBank');
}, (err) => {
	console.log('\n');
	console.log('------------------------');
	console.log('CHAINCODE INVOCATION FAILED:', err);
	console.log('issueAcceptedLC FAILED');
	console.log('------------------------');
	console.log('\n');
	process.exit(1);
})
.then((result) => {
	...
	// INVOKE: acceptAcceptedLC (Lender's Bank)
...
.then((result) => {
	...
	console.log('-------------------------');
	console.log('CHAINCODE INVOCATION COMPLETE');
	console.log('acceptAcceptedLC succeed.');
	console.log('-------------------------');
	console.log('\n');

	// QUERY: getAcceptedLCStatus (Lender's Bank)
	return queryCC.queryChaincode(Constants.LENDER_ORG, Constants.CHAINCODE_VERSION, 'getAcceptedLCStatus', [tradeID], 'LendersBank');
}, (err) => {
	console.log('\n');
	console.log('------------------------');
...
.then((result) => {
	...
	// TODO: issue accept L/C to Lender, and receive money from Lender
	// INVOKE: requestPayment (Exporter)
	return invokeCC.invokeChaincode(Constants.EXPORTER_ORG, Constants.CHAINCODE_VERSION, 'requestPaymentFromExporter', [tradeID], 'Exporter');
}, (err) => {
	console.log('\n');
	console.log('------------------------');
	console.log('CHAINCODE QUERY FAILED:', err);
...
.then(() => {
	...
	// INVOKE: makePayment (Lender's Bank)
	return invokeCC.invokeChaincode(Constants.LENDER_ORG, Constants.CHAINCODE_VERSION, 'makePaymentByLender', [tradeID], 'LendersBank');
}, (err) => {
	console.log('\n');
	console.log('-----------------------------');
	console.log('CHAINCODE INVOCATION FAILED:', err);
...
.then((result) => {
	...
	// QUERY: getAccountBalance (Lender's Bank)
	return queryCC.queryChaincode(Constants.LENDER_ORG, Constants.CHAINCODE_VERSION, 'getAccountBalance', [tradeID, 'lender'], 'LendersBank');
}, (err) => {
	console.log('\n');
	console.log('-----------------------------');
	console.log('CHAINCODE INVOCATION FAILED:', err);
...
.then((result) => {
	...
	// TODO: requestPayment from Lender instead of Exporter?
	// INVOKE: requestPayment (Exporter)
	return invokeCC.invokeChaincode(Constants.LENDER_ORG, Constants.CHAINCODE_VERSION, 'requestPaymentFromLender', [tradeID], 'LendersBank');
}, (err) => {
	console.log('\n');
	console.log('------------------------');
	console.log('CHAINCODE QUERY FAILED:', err);
...
.then(() => {
	...
	return invokeCC.invokeChaincode(Constants.IMPORTER_ORG, Constants.CHAINCODE_VERSION, 'makePaymentByImporter', [tradeID], 'Importer');
}, (err) => {
	console.log('\n');
	console.log('-----------------------------');
	console.log('CHAINCODE INVOCATION FAILED:', err);
